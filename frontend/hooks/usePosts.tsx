...
export function usePosts(): UsePostsReturn {
   ...
   * 公開記事一覧を取得
   */
  const fetchPublicPosts = useCallback(async (params?: PostSearchParams) => {
    setLoading(true);
    setError(null);
   ...
   * 公開記事詳細を取得
   */
  const fetchPublicPost = useCallback(async (id: number) => {
    setLoading(true);
    setError(null);
   ...
   * 管理者用記事一覧を取得
   */
  const fetchAdminPosts = useCallback(async (params?: PostSearchParams) => {
    setLoading(true);
    setError(null);
   ...
   * 管理者用記事詳細を取得
   */
  const fetchAdminPost = useCallback(async (id: number) => {
    setLoading(true);
    setError(null);
   ...
   * 記事を更新
   */
  const updatePost = useCallback(async (id: number, data: UpdatePostData) => {
    setLoading(true);
    setError(null);
