...
describe("Utils Library", () => {
  ...
  describe("formatDate utility", () => {
    ...
    it("should return null for invalid date conversion", () => {
      ...
      expect(
        result1 === null ||
          (result1 instanceof Date && isNaN(result1.getTime())),
      ).toBe(true);
  ...
  describe("stringUtils", () => {
    ...
    it("should strip HTML tags", () => {
      ...
      expect(stringUtils.stripHtml("<div><span>Test</span></div>")).toBe(
        "Test",
      );
    });
    ...
    it("should generate slugs", () => {
      ...
      expect(stringUtils.toSlug("Test  Multiple   Spaces")).toBe(
  ...
  describe("truncateText", () => {
    ...
    it("should use default length when not specified", () => {
      const longText =
        "This is a very long text that should be truncated to default length. This text is intentionally made longer than 100 characters to test the default truncation behavior properly.";
