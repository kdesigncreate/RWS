...
export interface UsePostsReturn extends UsePostsState {
  ...
  createPost: (data: CreatePostData) => Promise<{ success: boolean; post?: Post; error?: string }>;
  updatePost: (id: number, data: UpdatePostData) => Promise<{ success: boolean; post?: Post; error?: string }>;
